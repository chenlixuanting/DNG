    ...
    <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                ...
                <li><a class="dropdown-item" href="administrator/infoDetails"><i class="fa fa-user fa-lg"></i>
                    Profile</a></li>
                <li><a class="dropdown-item" href="backup/page-login.html"><i class="fa fa-sign-out fa-lg"></i>
                    Logout</a></li>
            </ul>
        </li>
    </ul>
