        ...
        <div class="col-md-6">
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <h4>Demo</h4><a class="btn btn-info" id="demoNotify" href="javascript:void(0);">Sample Notification</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <h4>Demo</h4><a class="btn btn-info" id="demoSwal" href="javascript:void(0);">Sample Alert</a>
            </div>
          </div>
        </div>
